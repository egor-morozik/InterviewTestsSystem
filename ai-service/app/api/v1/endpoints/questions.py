...
class QuestionGenerationRequest(BaseModel):
    description: str = Field(..., min_length=20, description="Описание того, какой вопрос нужен")
    difficulty: str = Field("medium", description="Сложность: easy/medium/hard")
    question_type: str = Field("multiple_choice", description="Тип: multiple_choice/code/text")
    language: Optional[str] = Field("python", description="Язык программирования для кодовых вопросов")
