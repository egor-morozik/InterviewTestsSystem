...
class AdminDashboardView(APIView):
    ...
    def get(self, request):
        ...
        pending_invitations = Invitation.objects.filter(completed=False, sent=True).count()
...
class InvitationListView(APIView):
    ...
    def get(self, request):
        ...
        data = [{
            ...
            } if inv.assigned_tech_lead else None,
...
class InvitationDetailView(APIView):
    ...
    def get(self, request, pk):
        ...
        return Response({
            ...
            } if invitation.assigned_tech_lead else None,
